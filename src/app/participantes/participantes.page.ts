...
visitantes:any[]=[];
  ...
  addParticipante(tipo:string){
    ...
    this.service.dadosApi(evento, "eventos.php").subscribe(ret =>{
      if (ret['success']){
...
atualizaParticipantes(){
  ...
  this.service.dadosApi(listatipos, "eventos.php").subscribe(ret =>{
    if (ret['success']){
...
atualizaVisitantes(){
  ...
  this.service.dadosApi(listarVisitante, "eventos.php").subscribe(ret =>{
    if (ret['success']){
...
remover(tipo:string){
  ...
  this.service.dadosApi(remover, "eventos.php").subscribe(ret =>{
    if (ret['success']){
      this.atualizaParticipantes();
    }
  });
...
async verificaVisitante(tipo:string){
  ...
  addVisitantePresente(id:any,nome:string ){
    ...
    this.service.dadosApi(add, "eventos.php").subscribe(ret =>{
      if (ret['success']){
        this.atualizaVisitantes();
      }
    });
